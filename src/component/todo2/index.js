...
const Todo2 = () => {   
    ...
    return ( 
        <>
        <div className="w-full h-24 bg-pink-300 flex justify-center">
            <div className="border-2 text-sky-600 w-32"onClick={() => changeView("list")}>LIST</div>
            <div className="border-2 text-sky-600 w-32"onClick={() => changeView("input")}>INPUT</div>
        </div>
        <div>
            {getView()}
        </div>
